...
// For L2-normalized matrices, the situation is a little trickier as we need to
// consider all of the possible types of normalized values we want to support.
